...
export const useFleetStore = defineStore("fleet", () => {
  ...
  // 대구 동구·수성구 이동 허용 경계
  const BOUNDS = { latMin: 35.855, latMax: 35.905, lngMin: 128.590, lngMax: 128.670 }

  // 동대구역 일대 초기 분산 위치 (차량 수만큼 순환)
  const GANGNAM_STARTS = [
    { lat: 35.8799, lng: 128.6285 }, // 동대구역
    { lat: 35.8760, lng: 128.6220 }, // 동대구역 서측
    { lat: 35.8830, lng: 128.6340 }, // 동대구역 북측
    { lat: 35.8710, lng: 128.6180 }, // 범어동 방향
    { lat: 35.8850, lng: 128.6150 }, // 신암동 방향
    { lat: 35.8680, lng: 128.6300 }, // 수성구 방향
    { lat: 35.8920, lng: 128.6250 }, // 대구역 방향
    { lat: 35.8750, lng: 128.6400 }, // 고산동 방향
    { lat: 35.8650, lng: 128.6350 }, // 만촌동 방향
    { lat: 35.8900, lng: 128.6380 }, // 지저동 방향
  ]
